...
class UserPanel extends React.Component {
  ...
  changeAvatar = () => {
    this.state.userRef.updateProfile({ photoURL: this.state.uploadedCroppedImage })
      .then(() => {
        ...
        <Grid.Column>
          <Grid.Row style={{ padding: "1.2em", margin: 0 }}>
            ...
            <Header inverted floated="left" as="h2">
              <Icon name="code" />
              <Header.Content>Snack</Header.Content>
            </Header>
          </Grid.Row>
            ...
            <Grid centered stackable columns={3}>
              <Grid.Row centered>
                <Grid.Column className="ui center aligned grid">
                  {previewImage && (
                    <AvatarEditor ref={node => (this.avatarEditor = node)} image={previewImage} width={120} height={120} border={50} />
                  )}
