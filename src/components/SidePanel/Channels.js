...
class Channels extends React.Component {
    ...
    addChannel = () => {
        ...
        const newChannel = {
            id: key,
            name: channelName,
            details: channelDetails, createdBy: {
        ...
        return (
            <React.Fragment>
                <Menu.Menu className="menu">
                    ...
                    </span>{" "}({this.state.channels.length}) <Icon name="add" onClick={this.openModal} />
                    </Menu.Item>
                ...
                <Modal basic open={this.state.modal} onClose={this.closeModal}>
                    ...
                    <Modal.Actions>
                        <Button color="green" inverted onClick={this.handleSubmit}><Icon name="checkmark"></Icon>Add</Button>
                        <Button color="red" inverted onClick={this.closeModal}><Icon name="remove"></Icon>Remove</Button>
                    </Modal.Actions>
                </Modal>
            </React.Fragment>
        );
